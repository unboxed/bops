...
export default class extends Controller {
  connect() {
    ...
    if (constraints !== null) {
      for (const constraint of constraints) {
        layers.push(
          this.buildConstraintsLayer(constraint),
        )
      }
    }
  ...
  buildConstraintsLayer(constraint) {
    const colours = {
      "agricultural-land-classification": { fill: "#00703c33", border: "#00703c" },
      "ancient-woodland": { fill: "#00703c33", border: "#00703c" },
      "area-of-outstanding-natural-beauty": { fill: "#d5388099", border: "#d53880" },
      ...
      "local-resilience-forum-boundary": { fill: "#f499be19", border: "#f499be" },
      ...
      "site-of-special-scientific-interest": { fill: "#308fac99", border: "#308fac" },
      ...
      "world-heritage-site-buffer-zone": { fill: "#EB1EE533", border: "#EB1EE5" },
    }

    const [key, geojson] = Object.entries(constraint)[0]

    return L.geoJson(geojson, {
      style: () => {
        const fillColor = colours[key]?.fill || "#00000033"
        const borderColor = colours[key]?.border || "#000000"
        return {
          fillColor,
          color: borderColor,
          weight: 2,
      ...
      onEachFeature: (feature, layer) => {
        layer.on("click", () => {
          this.showConstraintDetails(key)
        })
      },
    })
  }
