...
module Reviewing
  module PlanningApplicationPolicyClass
    class LinkComponent < ViewComponent::Base
      ...
      attr_reader :planning_application_policy_class, :policy_class, :part

      def link_path
        case planning_application_policy_class&.current_review&.review_status
        when "review_complete"
          planning_application_review_policy_class_path(planning_application_policy_class.planning_application, planning_application_policy_class)
        else
          edit_planning_application_review_policy_class_path(planning_application_policy_class.planning_application, planning_application_policy_class)
        end
      end
