...
class PlanningApplication
  class PublicitysController < AuthenticationController
    ...
    def create
      ...
      if @consultation.save!
        respond_to do |format|
          format.html { redirect_to planning_application_publicity_path(@planning_application, @consultation) }
        end
      else
        render :new
      end
    ...
    def redirect_path
      if request.referer&.include?("edit")
        edit_planning_application_publicity_path(@planning_application, @consultation)
      else
        planning_application_publicity_path(@planning_application, @consultation)
      end
    end
