...
module PlanningApplications
  class PublicationsController < AuthenticationController
    ...
    def ensure_planning_application_is_publishable
      ...
      redirect_to planning_application_assessment_tasks_path(@planning_application),
        alert: t(
          "planning_applications.publications.new.not_publishable",
    ...
    def ensure_site_notice_displayed_at
      ...
      flash.now[:alert] = t(
        "planning_applications.publications.create.confirm_site_notice_displayed_at_html",
    ...
    def ensure_press_notice_published_at
      ...
      flash.now[:alert] = t(
        "planning_applications.publications.create.confirm_press_notice_published_at_html",
