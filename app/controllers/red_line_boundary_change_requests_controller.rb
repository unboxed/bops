class RedLineBoundaryChangeRequestsController < ApplicationController
  ...
  def create
    @red_line_boundary_change_request = RedLineBoundaryChangeRequest.new(red_line_boundary_change_request_params.merge!({planning_application_id: @planning_application.id}) )
