...
gem "bops_enforcements", path: "engines/bops_enforcements"
gem "bops_preapps", path: "engines/bops_preapps"
gem "bops_reports", path: "engines/bops_reports"
gem "bops_submissions", path: "engines/bops_submissions"
