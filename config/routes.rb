...
Rails.application.routes.draw do
  ...
  direct :planning_application_assessment_site_description do |pa|
    pa.site_description.present? ?
      [:edit, pa, :assessment, pa.site_description, category: :site_description] :
