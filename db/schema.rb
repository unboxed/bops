...
ActiveRecord::Schema.define(version: 2020_11_17_150740) do
  ...
  create_table "local_planning_authorities", force: :cascade do |t|
    t.string "name"
    t.string "subdomain"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "planning_applications", force: :cascade do |t|
    ...
    t.integer "local_planning_authority_id"
    ...
    t.index ["local_planning_authority_id"], name: "index_planning_applications_on_local_planning_authority_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["local_planning_authority_id"], name: "index_users_on_local_planning_authority_id"
