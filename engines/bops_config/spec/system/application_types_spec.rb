...
RSpec.describe "Application Types", type: :system, capybara: true do
  ...
  it "allows editing of the features" do
    ...
    within "dl div:nth-child(7) dd.govuk-summary-list__value" do
      ...
      expect(page).to have_selector("li", text: "Check legislative requirements")
    ...
    uncheck("Check legislative requirements")
    uncheck("Site visits")
    check("Check permitted development rights")
    check("Consultees")
    ...
    within "dl div:nth-child(7) dd.govuk-summary-list__value" do
      ...
      expect(page).not_to have_selector("li", text: "Check legislative requirements")
