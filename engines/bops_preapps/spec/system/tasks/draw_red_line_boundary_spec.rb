...
RSpec.describe "Draw red line boundary task", type: :system do
  ...
  it "navigates to the task from the sidebar" do
    ...
    expect(page).to have_current_path("/preapps/#{planning_application.reference}/check-and-validate/check-application-details/draw-red-line-boundary")
  ...
  it "marks task as complete when clicking save and mark as complete" do
