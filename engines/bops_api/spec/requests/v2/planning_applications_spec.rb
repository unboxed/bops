...
RSpec.describe "BOPS API" do
  ...
  before do
    create(:api_user, permissions: %w[validation_request:read planning_application:read planning_application:submit], token: "bops_EjWSP1javBbvZFtRYiWs6y5orH4R748qapSGLNZsJw", local_authority:)
