...
RSpec.describe "BOPS API" do
  ...
  before do
    ...
    create(:application_type, :ldc_proposed, local_authority:)
    create(:application_type, :listed, local_authority:)
    create(:application_type, :land_drainage, local_authority:)
    create(:application_type, :pa_part1_classA, local_authority:)
    create(:application_type, :pa_part_14_class_j, local_authority:)
    create(:application_type, :pa_part_20_class_ab, local_authority:)
    create(:application_type, :pa_part_3_class_ma, local_authority:)
    create(:application_type, :pa_part7_classM, local_authority:)
    create(:application_type, :minor, local_authority:)
    create(:application_type, :major, local_authority:)
    create(:application_type, :pre_application, local_authority:)
