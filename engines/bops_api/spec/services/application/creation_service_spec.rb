...
RSpec.describe BopsApi::Application::CreationService, type: :service do
  describe "#call" do
    ...
    context "when successfully calling the service with params" do
      ...
      [ActiveRecord::RecordInvalid, ActiveRecord::RecordNotFound, ArgumentError, NoMethodError, ActiveRecord::RecordNotUnique].each do |error|
      ...
      context "when environment is production" do
        ...
        it "raises an error" do
          expect { create_planning_application }.to raise_error(described_class::CreateError, "Creating planning applications using this endpoint is not permitted in production")
        end
      end
    end
  end
