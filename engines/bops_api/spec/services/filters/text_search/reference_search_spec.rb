  ...
  describe ".apply" do
    ...
    context "with matching reference" do
      it "returns applications matching the reference" do
        ...
        result = described_class.apply(scope, app1.reference.downcase)
    ...
    context "with partial match" do
      it "returns applications with partial reference match" do
        ...
        result = described_class.apply(scope, partial_ref)
    ...
    context "with no matches" do
      it "returns empty result" do
        result = described_class.apply(scope, "zzznotfound")
