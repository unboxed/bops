...
RSpec.describe "Profile", type: :system do
  ...
  it "allows the administrator to view the council's profile" do
    ...
    expect(page).to have_content("Proactive engagement statement")
  ...
  it "shows the correct hint text for the council's profile" do
    ...
    expect(page).to have_content("This statement will appear on all decision notices")
  ...
  it "allows the administrator to edit council's profile" do
    ...
    fill_in("Proactive engagement statement", with: "We take a proactive approach to decision-making.")
    ...
    expect(page).to have_content("We take a proactive approach to decision-making.")
  end
