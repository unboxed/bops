...
RSpec.describe "Add reporting details task", type: :system do
  ...
  %i[planning_permission pre_application].each do |application_type|
    context "for a #{application_type} case" do
      ...
      let(:reporting_type_code) { planning_application.application_type.reporting_types.first }
      let!(:reporting_type) do
        create(:reporting_type,
          code: reporting_type_code,
          categories: [planning_application.application_type.category].compact,
          description: "Test reporting type",
          guidance: "This is guidance for testing")
      end
      ...
      context "regulation 3 and 4 selection" do
      ...
      context "when reporting type has guidance" do
