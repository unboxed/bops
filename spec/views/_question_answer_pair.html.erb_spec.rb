...
RSpec.describe "planning_applications/_question_answer_pair.html.erb" do
  context "with a sequential question and answer" do
    ...
    it "displays a sequential pair" do
      render "planning_applications/question_answer_pair", policy_consideration: policy_consideration
