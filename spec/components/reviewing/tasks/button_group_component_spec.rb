...
RSpec.describe Reviewing::Tasks::ButtonGroupComponent, type: :component do
  ...
  it "renders only back button with no recommendation" do
    ...
    expect(page).not_to have_link("Review and publish decision",
      href: planning_application_publication_path(pa))
  ...
  it "renders only back button when not publishing" do
    ...
    expect(page).not_to have_link("Review and publish decision",
      href: planning_application_publication_path(rec.planning_application))
    expect(page).to have_link("Back",
