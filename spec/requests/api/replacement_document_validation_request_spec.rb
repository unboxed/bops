        ...
        expect(json["data"]).to contain_exactly(
          {
            ...
            old_document: {
              ...
              url: "http://planx.bops.services/files/#{old_document.representation.key}"
            }
          }.deep_stringify_keys,
          {
            ...
            old_document: {
              name: "proposed-floorplan.png",
              invalid_document_reason: "Document is invalid",
              url: "http://planx.bops.services/files/#{old_document2.representation.key}"
            },
            new_document: {
              name: "proposed-floorplan.png",
              url: "http://planx.bops.services/files/#{new_document.representation.key}"
            }
          }.deep_stringify_keys,
          {
            ...
            old_document: {
              ...
              url: "http://planx.bops.services/files/#{old_document3.representation.key}"
            }
          }.deep_stringify_keys
        )
      end
