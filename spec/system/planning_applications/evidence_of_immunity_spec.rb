...
RSpec.describe "Evidence of immunity" do
  ...
  context "when signed in as a reviewer" do
    let!(:planning_application) do
      create(:planning_application, :awaiting_determination, :from_planx_immunity, local_authority: default_local_authority)
    end
    ...
    context "when planning application is awaiting determination" do
      it "I can view the information on the review evidence of immunity page" do
        ...
        expect(page).to have_current_path(
          edit_planning_application_review_immunity_detail_path(planning_application, ImmunityDetail.last)
        )
