...
RSpec.describe "Planning Application correction journey", type: :system do
  ...
  context "Assessor responding to reviewer" do
    ...
    it "Assessment can be corrected and resubmitted" do
      sign_in assessor
      visit root_path
  ...
  context "Reviewer first stage" do
    ...
    it "Reviewer can leave comment for assessor" do
      sign_in reviewer
      visit root_path
  ...
  context "Reviewer second stage" do
    ...
    it "Reviewer can see corrections alert which disappears after determination" do
      sign_in reviewer
      visit root_path
