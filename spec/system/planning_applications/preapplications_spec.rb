...
RSpec.describe "assigning planning application" do
  ...
  context "when application is a preapp" do
    let(:planning_application) { create(:planning_application, :preApp, local_authority:) }
    ...
    it "can edit preapp services" do
      within "#preapplication-services" do
        click_on "Change"
      end
  ...
  context "when application is not a preapp" do
    ...
    it "cannot edit preapp services" do
      visit "/planning_applications/#{planning_application.reference}/preapplication_services/edit"
