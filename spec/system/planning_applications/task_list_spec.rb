...
RSpec.describe "Planning Application show page", type: :system do
  ...
  context "as a reviewer" do
    ...
    it "should make valid task list for not_started" do
      planning_application = create(:planning_application, :not_started, local_authority: local_authority)
    ...
    it "should make valid task list for when it has been validated but no proposal has been made" do
      planning_application = create(:planning_application, local_authority: local_authority)
      visit planning_application_path(planning_application.id)
    ...
    it "should make valid task list for when it in assessment and a proposal has been created" do
      planning_application = create(:planning_application, local_authority: local_authority)
    ...
    it "should make valid task list for when it is awaiting determination" do
      planning_application = create(:planning_application, :awaiting_determination, local_authority: local_authority)
      create(:recommendation, planning_application: planning_application)
      visit planning_application_path(planning_application.id)
      task_item_exists("Validate documents", linked: true, completed: true)
    ...
    it "should make valid task list for when it is awaiting determination and recommendation has been reviewed" do
      planning_application = create(:planning_application, :awaiting_determination, local_authority: local_authority)
    ...
    it "should make valid task list for when it is determined" do
      planning_application = create(:planning_application, :determined, local_authority: local_authority)
      create(:recommendation, :reviewed, planning_application: planning_application)
      visit planning_application_path(planning_application.id)
    ...
    it "should make valid task list for when it is awaiting correction and no re-proposal has been made" do
      planning_application = create(:planning_application, :awaiting_correction, local_authority: local_authority)
      create(:recommendation, :reviewed, planning_application: planning_application)
      visit planning_application_path(planning_application.id)
      task_item_exists("Validate documents", linked: true, completed: true)
      task_item_exists("Assess Proposal", linked: true, completed: false)
    ...
    it "should make valid task list for when it is awaiting correction and a re-proposal has been made" do
      planning_application = create(:planning_application, :awaiting_correction, local_authority: local_authority)
      create(:recommendation, :reviewed, planning_application: planning_application)
      create(:recommendation, planning_application: planning_application)
      visit planning_application_path(planning_application.id)
