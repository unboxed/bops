...
RSpec.describe "Requesting other changes to a planning application", show_sidebar: false, type: :system do
  ...
  it "only accepts a request that contains a summary and suggestion" do
    ...
    expect(page).to have_current_path(
      "/planning_applications/#{planning_application.reference}/validation"
    )
  end
