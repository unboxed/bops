...
RSpec.describe "Review documents task", type: :system do
  ...
  context "when there are no documents" do
    it "displays a message indicating no active documents" do
      ...
      expect(page).to have_current_path("/planning_applications/#{planning_application.reference}/check-and-validate/check-tag-and-confirm-documents/review-documents")
  ...
  context "when there are documents" do
    ...
    it "redirects back to the task after editing a document" do
      ...
      expect(page).to have_current_path(%r{planning_applications/#{planning_application.reference}/check-and-validate/check-tag-and-confirm-documents/review-documents})
  ...
  context "with a lawfulness certificate application" do
