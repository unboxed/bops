...
RSpec.feature "Edit document numbers page", type: :system do
  ...
  context "as an assessor" do
    ...
    context "when there are documents that require numbers" do
      ...
      scenario "Assessor can see information about the document" do
      ...
      scenario "Assessor is able to add document numbers and save them" do
        within(all(".thumbnail").first) do
