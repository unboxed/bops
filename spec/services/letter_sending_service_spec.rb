    ...
    context "when it's a consultation letter" do
      context "when the request is successful" do
        ...
        it "makes a request and records it in the model" do
          ...
          described_class.new(letter_content, letter_type: :consultation).deliver!(neighbour)
      ...
      context "when the request is unsuccessful" do
        ...
        it "makes a request but does not record a sending date" do
          ...
          described_class.new("Hi", letter_type: :consultation).deliver!(neighbour)
    ...
    context "when it's a committee letter" do
      context "when the request is successful" do
        ...
        it "makes a request and records it in the model" do
          ...
          notify_request = stub_send_letter(status: 200)
          described_class.new(letter_content, letter_type: :committee).deliver!(neighbour)
      ...
      context "when the request is unsuccessful" do
        ...
        it "makes a request but does not record a sending date" do
          ...
          notify_request = stub_send_letter(status:)
          described_class.new("Hi", letter_type: :committee).deliver!(neighbour)
